...
if ($expediteurExiste && $destinataireExiste) {
    ...
    // Créer l'élément <content> avec l'attribut type="localisation" et les attributs latitude et longitude
    $content = $message->addChild('content');
    $content->addAttribute('type', 'localisation');
    $content->addAttribute('latitude', $latitude);
    $content->addAttribute('longitude', $longitude);
